...
public class DuplicatesRemover {
    ...
    public static void removeDuplicates(final List<String> list) {
    ...
    public static void removeDuplicatesUsingSet(final List<String> list){
        Set<String> stringSet = new LinkedHashSet<>(list);
        list.clear();
        list.addAll(stringSet);
    }

    public static void removeDuplicatesUsingStream(final List<String> list){
